...
class F18Exporter(Component):
    """Exporter flow 
    """

    _name = "f18.exporter"
    _inherit = ["f18.base.exporter"]
    ...
    def _export_dependency(self, relation, binding_model, component=None):
        ...
        # record but the binding model is 'f18.project.project'
        wrap = relation._model._name != binding_model

        if wrap and hasattr(relation, "f18_bind_ids"):
            domain = [
                ("odoo_id", "=", relation.id),
